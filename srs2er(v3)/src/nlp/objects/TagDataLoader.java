...
/*
 * 
 * DO NOT AUTO FORMAT THIS FILE! (Do NOT save it if you do.
 */
...
public class TagDataLoader
{
	...
	public enum TagType
	{
		UNKNOWN(00), NN(1, "Noun (Singular)"), NNS(2, "Noun (Plural)"), NNP(3,
				"ProperNoun (Singular)"), NNPS(4, "ProperNoun (Plural)"),

		VB(5, "Verb (Base Form)"), VBD(6, "Verb (Past Tense)"), VBG(7,
				"Verb (Gerund/Present Participle)"), VBN(8, "Verb (Past Participle"), VBP(9,
				"Verb (Singular Present, Non 3rd person)"), VBZ(10,
				"Verb (Singular Present, 3rd Person)"),

		RB(11, "Adverb"), RBR(12, "Adverb (Comparative)"), RBS(13, "Adverb (Superlative)"),

		JJ(14, "Adjective"), JJR(15, "Adjective (Comparative)"), JJS(16, "Adjective (Superlative)"),

		PRP(17, "Personal Pronoun"), PRP$(18, "Possessive Pronoun"), WP(19, "Wh­pronoun"), WP$(20,
				"Possessive Wh­Pronoun"), CC(21, "Coordinating Conjunction"), CD(22,
				"Cardinal Number"), DT(23), EX(24), FW(25), IN(26), LS(27), MD(28), PDT(29), POS(30), RP(
				31), SYM(32), TO(33), UH(34), WDT(35), WRB(36);
	...
	public static TagDataLoader getInstance() 
	{
		if (instance == null)
		{
	...
	public void load()
	{
		...
		{
			Logger.getLogger(this.getClass().getName()).warning("Failed to load tag cost matrix.");
			e.printStackTrace();
		}
	}
